...
static const char *scratchpadcmd[] = { "st", "-t", scratchpadname, "-g", "151x15", "-e", "tmux",NULL };
static const char *calculatorcmd[] = { "speedcrunch", NULL };

static Key keys[] = {
	/* modifier                     key        function        argument */
	{ CTRL,                         XK_space,  spawn,			{.v = dmenucmd } },
	{ CTRL|ALT,                     XK_t,  	   togglescratch,  	{.v = scratchpadcmd } },
	{ CTRL|ALT,                     XK_c,  	   spawnspeedcrunch,{.v = calculatorcmd } },
